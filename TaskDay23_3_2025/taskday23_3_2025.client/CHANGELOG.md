...
- Create Angular project with ng: `ng new taskday23_3_2025.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`taskday23_3_2025.client.esproj`).
